...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::iec104::iec104_generate_simulation_values,
            ...
            commands::iec61850::iec61850_delete_model,
            commands::iec61850::iec61850_apply_target_config,
            commands::iec61850::iec61850_upsert_ied,
            commands::iec61850::iec61850_get_ied,
            commands::iec61850::iec61850_list_ieds,
            commands::iec61850::iec61850_delete_ied,
            commands::iec61850::iec61850_start_ied,
            commands::iec61850::iec61850_stop_ied,
            commands::iec61850::iec61850_upsert_point_mappings,
            commands::iec61850::iec61850_get_point_mappings,
            commands::iec61850::iec61850_get_runtime_statistics,
            commands::modbus_rtu::modbus_rtu_update_config,
            commands::modbus_rtu::modbus_rtu_get_config,
            ...
            commands::modbus_tcp::modbus_tcp_upsert_link,
            commands::modbus_tcp::modbus_tcp_rename_link,
            commands::modbus_tcp::modbus_tcp_get_link,
            commands::modbus_tcp::modbus_tcp_list_links,
            commands::modbus_tcp::modbus_tcp_delete_link,
            commands::modbus_tcp::modbus_tcp_start_link,
            commands::modbus_tcp::modbus_tcp_stop_link,
            commands::modbus_tcp::modbus_tcp_upsert_point_table,
            commands::modbus_tcp::modbus_tcp_get_point_table,
            commands::dlt645::dlt645_update_config,
            commands::dlt645::dlt645_get_config,
            ...
            commands::data_center::dc_get_or_create_connection,
            commands::data_center::dc_get_conn_tags,
            commands::data_center::dc_upsert_conn_tags,
            ...
            commands::data_center::dc_get_throughput_snapshot,
            ...
            commands::agc::agc_start_tuning,
            commands::agc::agc_stop_tuning,
            commands::agc::agc_get_tuning_status,
            commands::agc::agc_get_control_profile,
            commands::agc::agc_confirm_control_profile,
            ...
            commands::calc::calc_upsert_group,
            commands::calc::calc_rename_group,
            commands::calc::calc_get_group,
            commands::calc::calc_list_groups,
            commands::calc::calc_delete_group,
            commands::calc::calc_start_group,
            commands::calc::calc_stop_group,
            commands::control_orchestrator::control_orchestrator_upsert_sequence,
            commands::control_orchestrator::control_orchestrator_get_sequence,
            commands::control_orchestrator::control_orchestrator_list_sequences,
            commands::control_orchestrator::control_orchestrator_delete_sequence,
            commands::control_orchestrator::control_orchestrator_execute_sequence,
            commands::export_config::save_full_config_export,
            commands::export_config::save_vertical_security_script,
            ...
            commands::lower_update::deploy_vertical_security_script,
            commands::lower_update::get_vertical_security_status,
